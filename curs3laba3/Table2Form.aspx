<%@ Page Title="" Language="C#" MasterPageFile="~/Universal_Thing.Master" AutoEventWireup="true" CodeBehind="Table2Form.aspx.cs" Inherits="curs3laba3.Table2Form" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Label1" runat="server" Text="Книги"></asp:Label>
    <br />
    <br />
